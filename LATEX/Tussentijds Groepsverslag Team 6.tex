...
\subsection{Ontwerp}
	...
	Voor de \textbf{detectie} van de brand maken we gebruik van dezelfde webcam (USB Webcam 1080P), in Python wordt een programma geschreven op een laptop die aan branddetectie en -lokalisatie doet. De camera is vastgemaakt op het roterend platform. \\
